...
System.out.println("In Teacherpro == "+TId);

String sql ="SELECT * FROM teacherregistration WHERE TId='"+TId+"'";
...
Id =resultSet.getString("TId");
  ...
  %>  
        ...
        <div class="home-caption" >
        	      ...
        	      <h1 class="home-title" style="font-size:23px; margin-top: 80px;">Apply For <i> <%=resultSet.getString("Name")%> </i> Tutor</h1>
   <br>         <a href="#" data-toggle='modal'  data-target='#ApplyTutor' > <button style="padding:8px; font-size:15px; color:#fff;  background-color:#6666FF ;border-radius:8px; ">Apply Here</button></a>  <br>  <br>
